    ...
    "State is a monad" - {
      ...
      /*
            "laws" in {
              ...
              monadSatisfiesFunctorLaws[IntState, Int, Double, String]
              monadSatisfiesMonadLaws[IntState, Int, Double, String]
              monadSatisfiesMonadLawsWithKleisliComposition[IntState, Int, Double, String, Boolean]
            }
      */
    }
  }
