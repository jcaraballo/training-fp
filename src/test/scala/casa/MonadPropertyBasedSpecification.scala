...
object MonadPropertyBasedSpecification extends Properties("Monad") {
  ...
  */
  ...
  def monadLaws[F[_], A, B, C](implicit monad: Monad[F],
                               arbA: Arbitrary[A],
                               arbFA: Arbitrary[F[A]],
  ...
  def monadLawsWithKleisliComposition[F[_], A, B, C, D](implicit monad: Monad[F],
                                                        arbA: Arbitrary[A],
                                                        arbFA: Arbitrary[F[A]],
                                                        arbAtoB: Arbitrary[A => B],
                                                        arbBtoC: Arbitrary[B => C],
  ...
  private def monadLeftIdentityLaw[F[_], A, B](implicit monad: Monad[F], arbA: Arbitrary[A], arbAtoFB: Arbitrary[A => F[B]]): Prop =
    forAll { (a: A, op: A => F[B]) =>
  ...
  private def monadAssociativityLaw[F[_], A, B, C](
  ...
  def monadLeftIdentityLawWithKleisliComposition[F[_], A, B](implicit monad: Monad[F],
                                                             arbA: Arbitrary[A],
                                                             arbAtoFB: Arbitrary[A => F[B]]
                                                            ): Prop =
    forAll { (a: A, op: A => F[B]) =>
  ...
  def monadRightIdentityLawWithKleisliComposition[F[_], A, B](implicit monad: Monad[F],
                                                              arbA: Arbitrary[A],
                                                              arbAtoFB: Arbitrary[A => F[B]]
                                                             ): Prop =
    forAll { (a: A, op: A => F[B]) =>
  ...
  def monadAssociativityLawWithKleisliComposition[F[_], A, B, C, D](
                                                                     implicit monad: Monad[F],
                                                                     arbA: Arbitrary[A],
                                                                     arbAtoFB: Arbitrary[A => F[B]],
                                                                     arbBtoFC: Arbitrary[B => F[C]],
